...
export const GAMEINFO_BASE =
  process.env.GAMEINFO_BASE || 'https://gameinfo.albiononline.com/api/gameinfo';
export const ALBION_DATA_BASE =
  process.env.ALBION_DATA_BASE || 'https://west.albion-online-data.com';
...
export const CELESTE_INTERVAL_MS = Number(
  process.env.CELESTE_INTERVAL_MS || process.env.COLLECTOR_INTERVAL_MS || 15 * 60 * 1000
);
