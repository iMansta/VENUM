// Portado de github.com/ao-data/albiondata-client (client/photon/parser.go),
// licenciado sob MIT License, Copyright (c) 2017 The Albion Data Project.
package photon
...
// RawPacket holds the raw UDP payload of one Photon packet.
type RawPacket struct {
	Payload []byte
}

// PhotonParser parses raw Photon UDP payloads and fires callbacks for each
// decoded operation or event.
...
// ReceivePacket processes a raw Photon UDP payload and fires the appropriate
