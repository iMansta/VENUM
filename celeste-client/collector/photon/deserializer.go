// Package photon implements a pure-Go Photon (Protocol18) deserializer.
//
// Portado de github.com/ao-data/albiondata-client (client/photon), licenciado
// sob MIT License, Copyright (c) 2017 The Albion Data Project.
//
// Usado apenas para identificar silenciosamente o personagem Albion local
...
const (
	...
	customTypeSlimBase   = byte(0x80) // gpType >= 0x80: slim custom type
)
